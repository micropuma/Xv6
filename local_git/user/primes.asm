...
void primes(int fd)
{
  ...
  30:	8e450513          	addi	a0,a0,-1820 # 910 <malloc+0xe4>
  34:	00000097          	auipc	ra,0x0
  38:	73a080e7          	jalr	1850(ra) # 76e <printf>
	int isFirst = 1;
  3c:	4485                	li	s1,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4de:	44e50513          	addi	a0,a0,1102 # 928 <digits>
 4e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5aa:	382b8b93          	addi	s7,s7,898 # 928 <digits>
 ...
 6ea:	23a90913          	addi	s2,s2,570 # 920 <malloc+0xf4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b2:	1927b783          	ld	a5,402(a5) # 940 <freep>
 ...
 7e0:	00e6ea63          	bltu	a3,a4,7f4 <free+0x50>
{
 ...
 822:	12f73123          	sd	a5,290(a4) # 940 <freep>
}
 826:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 854:	0f053503          	ld	a0,240(a0) # 940 <freep>
 ...
 87c:	0c890913          	addi	s2,s2,200 # 940 <freep>
  if(p == (char*)-1)
 880:	5afd                	li	s5,-1
 882:	a88d                	j	8f4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 884:	00000797          	auipc	a5,0x0
 888:	0c478793          	addi	a5,a5,196 # 948 <base>
 88c:	00000717          	auipc	a4,0x0
 890:	0af73a23          	sd	a5,180(a4) # 940 <freep>
 894:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8b6:	08a73723          	sd	a0,142(a4) # 940 <freep>
      return (void*)(p + 1);
